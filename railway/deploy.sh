...
echo "  6. Mount volume at /home/ghost/content (entrypoint auto-seeds empty volumes)"
echo "  7. Set variables from railway/ghost.env.example"
echo "  8. Add RESEND_API_KEY secret"
echo "  9. Generate domain, set url=https://... (exact browser domain)"
echo " 10. Reinstall custom themes / images if volume was previously empty"
echo " 11. Deploy bridge from hubspot-bridge (cron sync)"
echo ""
